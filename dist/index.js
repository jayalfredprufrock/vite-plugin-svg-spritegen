...
var writeGitignore = async (filePath, spriteName, typesName) => {
	const content = [
		"# svg spritegen",
		spriteName,
		typesName
	...
	try {
		...
		if (currentContent.includes(content)) return;
		else await node_fs.promises.writeFile(filePath, currentContent + "\n" + content, "utf8");
	} catch (e) {
